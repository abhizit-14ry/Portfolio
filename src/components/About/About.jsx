...
import profileImage from '../../assets/Abhii.png';
    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-10">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          {/* Name */}
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-lime-200 mb-4 leading-tight">
            Abhijeet Chaudhary
          </h2>
...
I          enjoy learning new technologies and am eager to start my professional journey 
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/14Zb1EFQVMVlWzYpaSLTSDvdnJS8jolXq/view?usp=sharing"
            target="_blank"
